...
<!-- Kenburns SlideShow -->
 <section class="parallax-header valign bg-img bg-fixed" data-overlay-dark="5" data-background="img/offers/services-page.png">
        <div class="container">
        ...
        <div class="row g-4">
            ...
            <div id="hotel" class="col-12 col-md-6 col-lg-4">
             ...
             <div id="hotel" class="col-12 col-md-6 col-lg-4">
                <div class="luxx-card-premium">
                    <div class="luxx-card-image">
                        <img src="img/offers/jet.jpg" alt="Hotels and Short Stays">
                    </div>
                    <div class="luxx-card-body">
    ...
    <div class="row justify-content-center mt-5">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8">
                <div class="app-notice text-center">
                    <div class="notice-badge">Important Notice</div>
                    <p class="notice-text mb-0">
                        All bookings and registrations are available only via our mobile application, launching soon.
                    </p>
                </div>
            </div>
        </div>
