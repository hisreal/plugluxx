...
require_once ('Mail/mime.php'); // PEAR Mail_Mime packge
 ...
 $from = "ajiboye820@gmail.com"; //enter your email address
 $to = "test@theplugluxx.com"; //enter the email address of the contact your sending to
...
$headers = $mime->headers($headers);
 ...
 $username = "test@theplugluxx.com"; //  your email address (same as webmail username)
 $password = "E]i2.#clARr0w_R6"; // your password (same as webmail password)
...
// header("Location: http://www.example.com/");
 ...
 <form action="qservers_mail" method="post">
